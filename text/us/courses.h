...
COURSE_ACTS(COURSE_MY_LEVEL, _("1  MY LEVEL"),  
_("GET THAT STAR!"), _("NOT POSSIBLE."), _("NOT REAL."),  _("HOW ARE YOU EVEN SEEING THIS?"), 
_("YOU JUST GIT CLONED THE REPO DID YOU?"), _("COOL I GUESS."))
