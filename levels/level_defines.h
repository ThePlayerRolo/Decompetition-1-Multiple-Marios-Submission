...
DEFINE_LEVEL("MY_LEVEL", LEVEL_MY_LEVEL, COURSE_MY_LEVEL, MY_LEVEL, generic, 20000, 0x00, 0x00, 0x00, _, sCamMyLevel) 
DEFINE_LEVEL("MY_HUB", LEVEL_MY_HUB, COURSE_MY_HUB, MY_HUB, generic, 20000, 0x00, 0x00, 0x00, _, sCamMyHub) 