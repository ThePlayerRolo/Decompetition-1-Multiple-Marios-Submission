...
extern Vtx MY_LEVEL_dl_Level_Mesh_mesh_layer_1_vtx_0[76];
extern Gfx MY_LEVEL_dl_Level_Mesh_mesh_layer_1_tri_0[];
extern Vtx MY_LEVEL_dl_Plane_mesh_layer_5_vtx_cull[8];
extern Vtx MY_LEVEL_dl_Plane_mesh_layer_5_vtx_0[4];
extern Gfx MY_LEVEL_dl_Plane_mesh_layer_5_tri_0[];
extern Gfx mat_MY_LEVEL_dl_Grass_Example[];
extern Gfx mat_revert_MY_LEVEL_dl_Grass_Example[];
extern Gfx mat_MY_LEVEL_dl_Death[];
extern Gfx mat_revert_MY_LEVEL_dl_Death[];
extern Gfx MY_LEVEL_dl_Level_Mesh_mesh_layer_1[];
extern Gfx MY_LEVEL_dl_Plane_mesh_layer_5[];
